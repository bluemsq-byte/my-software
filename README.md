...
- 本地音乐首页取消“歌曲/文件夹”切换按钮，改为歌曲列表和文件夹图标入口。
- 本地文件夹支持按真实目录逐层进入。
- 播放列表添加本地歌曲改为文件夹分层多选。
- 网络音乐“仅显示音频”移动到设置页。
- App 启动、系统重启、时间变化和版本更新后自动恢复已启用定时。

## 安装包

- Release APK：`dist/audio-player-v1.8.3.apk`
- Debug APK：`dist/audio-player-v1.8.3-debug.apk`
